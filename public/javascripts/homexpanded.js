...
exports.view2 = function (req, res){
	buttonID1 = req.query.buttonID;
	console.log('homexpand1: ' + req.query['buttonID1']);
	console.log('data: ' + data['myhomepage']);
	res.render('homexpanded1', data.myhomepage[buttonID1]); 
	// will only send the first element of the array "myhomepage"
}

exports.view3 = function (req, res){
	var buttonID = req.query.buttonID;
	console.log('homevent1: ' + req.query['buttonID']);
	console.log('data: ' + data['myhomepage']);
	res.render('homevent1', data.myhomepage[buttonID1].suggestions[buttonID]); 
	// will only send the first element of the array "myhomepage"
}
